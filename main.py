...
def choice_char_class():
    ...
    while approve_choice != 'y':
        char_class = input('''Введи название персонажа играть: 
        'Воитель — warrior, Маг — mage, Лекарь — healer: ''')
        if char_class == 'warrior':
            print('Воитель — дерзкий воин ближнего боя. Сильный, отважный.')
        if char_class == 'mage':
            print('Маг — находчивый воин дальнего боя. высоким интеллектом.')
        if char_class == 'healer':
            print('Лекарь — аклинатель.Черпает силы из природы,веры и духов.')
        approve_choice = input('''Нажми (Y), чтобы подтвердить, или другую ,
